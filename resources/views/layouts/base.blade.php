		...
		<div class="header-cart flex-col-l p-l-65 p-r-25">
			...
			<div class="header-cart-content flex-w js-pscroll">
				<ul class="header-cart-wrapitem w-full">
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-txt p-t-8">
							<a href="{{ route('admin.settings') }}" class="header-cart-item-name m-b-18 hov-cl1 trans-04">Settings</a>
						</div>
					</li>
				</ul>
			...
			<div class="header-cart-content flex-w js-pscroll">
				<ul class="header-cart-wrapitem w-full">
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-txt p-t-8">
							<a href="{{ route('user.orders') }}" class="header-cart-item-name m-b-18 hov-cl1 trans-04">
								My Orders
							</a>
						</div>
					</li>
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-txt p-t-8">
							<a href="{{ route('user.changepassword') }}" class="header-cart-item-name m-b-18 hov-cl1 trans-04">
								Change Password
							</a>
						</div>
					</li>
