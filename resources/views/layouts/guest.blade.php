					...
					@if(Route::has('login'))
						@auth
							@if(Auth::user()->utype === 'ADM')
								<a href="#" class="flex-c-m trans-04 p-lr-25">{{ Auth::user()->name }}</a>
								<a href="{{ route('admin.dashboard') }}" class="flex-c-m trans-04 p-lr-25">Dashboard</a>
								<a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="flex-c-m trans-04 p-lr-25">Logout</a>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						@endif
							<a href="{{ route('product.cart') }}" class="zmdi zmdi-shopping-cart"></a>
						</div>
