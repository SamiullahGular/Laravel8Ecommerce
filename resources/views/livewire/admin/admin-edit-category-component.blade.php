            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form" wire:submit.prevent="updateCategory">
                        ...
                        <div class="form-group">
                            <button type="submit" name="submit"class="btn btn-info js-edit-alert">Submit</button>
...
<script>
    /*------------------ Alert for Edit category --------------------- */
		$('.js-edit-alert').each(function(){
			$(this).on('click', function(){
				swal('Category', "has been updated successfully !", "success");
			});
		});
</script>
