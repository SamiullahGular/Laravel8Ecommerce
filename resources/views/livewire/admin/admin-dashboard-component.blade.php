<div class="content container admin-con pt-5">   
    <style>
        .content {
          padding-top: 40px;
          padding-bottom: 40px;
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">    
              <div class="icon-stat">    
                ...
                <div class="icon-stat-footer p-2">
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($orders as $order)
                                   <tr>
                                       ...
                                       <td>
                                           <a href="{{route('user.orderdetail', ['order_id'=> $order->id ])}}" class="btn btn-outline-primary">Detail</a>
                                       </td>
                                   </tr>
                                @endforeach
                               </tbody>
