                    ...
                    <form class="row" enctype="multipart/form-data" wire:submit.prevent="updateProduct()">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                @if($new_image)
                                    <img src="{{ $new_image->temporaryUrl() }}" alt="$name" width="120px">
                                @else
                                    <img src="{{ asset('assets/images')}}/{{$image}}" alt="$name" width="120px">
                                @endif
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @if($images)
                                    ...
                                    @endforeach
                                @else
                                    @php $oldImgs = explode(',', $old_images) @endphp
                                    @foreach($oldImgs as $img)
                                        <img src="{{ asset('assets/images')}}/{{$img}}" alt="$name" width="120px">
                                    @endforeach
                                @endif
                            </div>
                        </div>
...
<script>
	...
	// 		swal('Product', "has been updated successfully !", "success");
	// 	});
	// });
</script>
