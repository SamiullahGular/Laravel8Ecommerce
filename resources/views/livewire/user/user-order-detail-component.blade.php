<div class="container-fluid p-5 admin-con">
    <div class="row">
        <div class="col-12">
            @if(Session::has('cancel_order_msg'))
                <div class="alert alert-success">{{ Session::get('cancel_order_msg')}}</div>
            @endif
            <div class="card mt-3">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a href="{{route('user.orders')}}" class="btn btn-success btn-rounded cat-button">All Orders</a>
                            @if($order->status == 'ordered')
                                <a href="#" wire:click.prevent="cancelOrder" class="btn btn-warning btn-rounded cat-button" style="margin-right: 3px;">Cancel Order</a>
                            @endif
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table-shopping-cart">
                                        ...
                                        @foreach($order->orderItems as $item)
                                            <tr class="table_row">
                                                ...
                                                @if($order->status == 'delivered' && $item->rstatu == false)
                                                    <td class="column-5"><a href="{{ route('user.review', ['order_item_id'=> $item->id])}}">Write Review</a></td>
                                                @endif
                                            </tr>
                                        @endforeach
                                    </table>
